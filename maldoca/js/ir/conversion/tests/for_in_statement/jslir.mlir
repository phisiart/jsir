...
// JSLIR-NEXT:     %8 = "jslir.for_in_statement_start"(%6, %7) <{left_declaration = #jsir<for_in_of_declaration   <L 4 C 5>, <L 4 C 10>, 24, 29, 2,   <L 4 C 9>, <L 4 C 10>, 28, 29, 2, "let">}> : (!jsir.any, !jsir.any) -> !jsir.any
